...
The deadline for handing in the exercise is XX. 
...
-   Check in your folder if the structure was created. 

-   Check if your project root directory is set to the path you want it to be.

-  Save the script with a name of your choice in the folder "03_script". Click on File -\> Save as... -\> navigate to 03_script.
...
d_proj <- "/Users/jb22m516/Documents/GitHub/getting_started_with_R/exercises/"
